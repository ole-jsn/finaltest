...
export const ConversationDetails = ({
	...
	async function loadOlderMessages() {
		try {
			...
			toast.error("alte Nachrichten konnten nicht geladen werden...");
		}
	}
	...
	async function handleDeleteConversation(conversationId: string) {
		if (
			confirm(
				'Bist du sicher diese Konversation zu löschen? Alle Informationen werden verloren gehen!'
			)
		) {
			try {
			...
			<div className="w-2/3 flex flex-col default-border bg-white">
				{isLoadingMessages ? (
					<div className="self-center bg-zinc-200 p-6 text-lg font-medium rounded-md my-auto flex flex-col items-center gap-5">
						<LoadingAnimation label="Nachrichten werden geladen..." />
